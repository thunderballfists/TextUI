...
Run `textui run examples/controls/app.ui` to try native select, switch, text area, and tabbed content widgets. Their `on-*` actions update the feedback label. See the [controls guide](../docs/controls.md).
