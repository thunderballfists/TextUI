...
- Clickable data-table headings that toggle ascending and descending order, show the active `↑`/`↓` direction, and use original runtime record values or displayed seed values.
